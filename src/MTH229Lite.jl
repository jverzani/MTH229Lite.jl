...
* The operator `'` is overloaded for functions to find the derivative using the `ForwardDiff` package
...
export plot, plot!, scatter, scatter!, annotate, annotate!, title!, size!, xlims!, ylims!, legend!
export unzip, plotif
